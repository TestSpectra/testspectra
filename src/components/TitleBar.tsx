...
export function TitleBar({
  ...
  const MacOSControls = () => (
    <div className="flex items-center gap-2 pl-3 group">
      ...
      >
        <Square
          className="w-1.5 h-1.5 text-[#004d00] opacity-0 group-hover:opacity-100 transition-opacity"
          strokeWidth={3}
        />
      </button>
    </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs text-slate-500" data-tauri-drag-region>
          •
        </span>
        <span className="text-xs text-slate-400" data-tauri-drag-region>
