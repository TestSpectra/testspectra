...
export function TestCasesList({
  ...
  return (
    <div className="p-8">
      ...
      {/* Loading State - initial / empty table */}
      {isLoading && !hasData && (
      ...
      {/* Table with optional loading overlay when reloading over existing data */}
      {!isLoading || hasData ? (
        <div className="relative">
          {isLoading && hasData && (
            <div className="absolute inset-0 z-10 bg-slate-900/60 backdrop-blur-[1px] flex items-center justify-center">
              <div className="flex items-center gap-2 text-xs text-slate-200">
                ...
                <span>Memuat test cases terbaru...</span>
              </div>
            </div>
          )}
