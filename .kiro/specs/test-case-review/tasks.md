...
- [ ] 2. Backend: Review models and handlers
  - [ ] 2.1 Create review data models in models/review.rs
  ...
  - [ ] 2.2 Implement review handler endpoints
...
- [ ] 3. Backend: Notification models and handlers
  - [ ] 3.1 Create notification data models in models/notification.rs
  ...
  - [ ] 3.2 Implement notification handler endpoints
  ...
  - [ ] 3.3 Implement notification service
...
- [ ] 4. Backend: WebSocket implementation
  ...
  - [ ] 4.2 Implement WebSocket handler endpoint
  ...
  - [ ] 4.3 Integrate WebSocket with notification service
...
- [ ] 5. Backend: Update test case handler for review status
  - [ ] 5.1 Modify create_test_case to set review_status to pending
    - Update INSERT query to include review_status field
    - _Requirements: 1.1_

  - [ ] 5.2 Modify update_test_case to reset review_status to pending
    - Add logic to check current review_status
    - Reset to pending if status is approved or needs_revision
    - _Requirements: 1.3, 1.4_

  - [ ] 5.3 Add review_status filter to list_test_cases
...
- [ ] 6. Backend: Wire up all handlers to main router
...
- [ ] 8. Frontend: Review service and types
  - [ ] 8.1 Create review types in types or models
    - Define ReviewAction, ReviewStatus types
    - Define Review, CreateReviewRequest interfaces
    - _Requirements: 2.3, 2.5_

  - [ ] 8.2 Create review service in services/review-service.ts
    - Implement createReview method
    - Implement getReviewHistory method
    - Add error handling
    - _Requirements: 2.3, 2.5, 3.2_

- [ ] 9. Frontend: Notification service and types
  - [ ] 9.1 Create notification types
    - Define NotificationType, Notification interfaces
    - Define NotificationListResponse interface
    - _Requirements: 4.1, 4.2, 7.1_

  - [ ] 9.2 Create notification service in services/notification-service.ts
...
- [ ] 10. Frontend: WebSocket implementation
  ...
  - [ ] 10.2 Create WebSocket context provider
...
- [ ] 11. Frontend: Review UI components
  - [ ] 11.1 Create ReviewSection component
  ...
  - [ ] 11.2 Create ReviewHistory component
  ...
  - [ ] 11.3 Integrate review components into TestCaseDetail
...
- [ ] 12. Frontend: Notification UI components
  - [ ] 12.1 Create NotificationPanel component
  ...
  - [ ] 12.2 Create NotificationBadge component
    - Display unread notification count
    - Add visual indicator for unread notifications
    - Toggle NotificationPanel on click
    - _Requirements: 4.5_

  - [ ] 12.3 Integrate notification components into Layout
...
- [ ] 13. Frontend: Test case list enhancements
  - [ ] 13.1 Add review status badge to TestCasesList
    - Display badge with appropriate color and text for each status
    - Add badge to each test case row
    - _Requirements: 6.1, 6.2, 6.3, 6.4_

  - [ ] 13.2 Add review status filter to TestCasesList
...
- [ ] 14. Frontend: Connect WebSocket to notification updates
...
- [ ] 15. Frontend: Update test case service
